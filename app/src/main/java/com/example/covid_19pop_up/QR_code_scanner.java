...
//                        showtext.setMovementMethod(LinkMovementMethod.getInstance());
                        ...
                        if (result.getText().isEmpty()){
                            ...
                            View alertCustomdialog = LayoutInflater.from(QR_code_scanner.this).inflate(R.layout.qr_popup,null);
                            //initialize alert builder.
                            AlertDialog.Builder alert = new AlertDialog.Builder(QR_code_scanner.this);
                            ...
                            show_info.setOnClickListener(new View.OnClickListener() {
                                @Override
                                public void onClick(View view) {
                                    ClipboardManager cm = (ClipboardManager)QR_code_scanner.this.getSystemService(Context.CLIPBOARD_SERVICE);
                                    // cm.setText(textView.getText());
                                    Toast.makeText(QR_code_scanner.this, "Copied to clipboard", Toast.LENGTH_SHORT).show();
                                }
                            });
